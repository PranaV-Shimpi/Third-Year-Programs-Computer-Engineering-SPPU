/*
===========================================================================================
Write a Java/ C program to create child process using fork
system call. Display status of running processes (ps), use
it in child process (exec) and terminate child process
before completion of parent task(wait).
